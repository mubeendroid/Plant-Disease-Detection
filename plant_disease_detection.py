"""
Author: Mubeen Ul Alam
Website: https://mubeendroid.com
"""
...
try:
    ...
    for plant_folder in root_dir:
        print(f'Folder name: {plant_folder}')
...
print(f'Total images: {image_size}')
...
print(f'Disease class labels: {label_binarizer.classes_}')
